...
ICONS = {
    ...
    "reservas": ("#0E7490", '<path d="M7 2h2v2h6V2h2v2h2a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2V2Zm12 8H5v9h14v-9Zm-9.6 2 1.4 1.4 3.3-3.3 1.4 1.4-4.7 4.7-2.8-2.8 1.4-1.4Z"/>'),
}
